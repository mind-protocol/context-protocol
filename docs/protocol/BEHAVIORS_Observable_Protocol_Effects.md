# Context Protocol — Behaviors: Observable Protocol Effects
...
THEN:   The agent loads .context-protocol/PROTOCOL.md first
...
THEN:   The agent updates .context-protocol/state/SYNC_Project_State.md
...
AND:    Templates are used from .context-protocol/templates/
```
...
- `.context-protocol/views/VIEW_*.md`
- `.context-protocol/templates/*.md`
