...
**File sizes:** [('IMPLEMENTATION_TUI_Code_Architecture.md', '11K'), ('SYNC_TUI_State.md', '11K'), ('BEHAVIORS_TUI_Interactions.md', '6K'), ('ALGORITHM_TUI_Flow.md', '5K'), ('TEST_TUI_Coverage.md', '4K')]
...
## Archiving pattern:
- Create `docs/tui/archive/SYNC_archive_2024-12.md` for old content
