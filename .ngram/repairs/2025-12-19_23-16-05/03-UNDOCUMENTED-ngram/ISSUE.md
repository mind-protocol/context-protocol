...
**Target:** `ngram`
**Problem:** No documentation mapping (46 files)

## CRITICAL: Check for existing docs first

Before creating anything, search for existing documentation:
- `grep -r "ngram" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `ngram` to understand what it does
