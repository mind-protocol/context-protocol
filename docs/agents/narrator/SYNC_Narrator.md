...
<!-- @ngram:todo Consolidate narrator schema references under `docs/schema/SCHEMA.md`. -->
<!-- @ngram:todo Implement hallucination detection for unprompted entity creation. -->
