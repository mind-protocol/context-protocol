"""
Context and dependency analysis for Context Protocol CLI.
...
def get_traces_dir(target_dir: Path) -> Path:
    ...
    traces_dir = target_dir / ".context-protocol" / "traces"
...
def find_module_docs(target_dir: Path, file_path: Path) -> Optional[Path]:
    ...
    # e.g., src/context_protocol/cli.py -> docs/context_protocol/cli/
    try:
