...
### MONOLITH: `src/ngram/doctor.py` (551.7s)
...
1. **Run `ngram doctor`** to see the current issue breakdown—identify the 3 critical issues specifically
...
- `src/ngram/doctor.py` - extracted to `doctor_checks.py`, `doctor_files.py`, `doctor_report.py`, `doctor_types.py`
