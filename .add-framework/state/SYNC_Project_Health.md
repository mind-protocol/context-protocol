...
UPDATED_BY: add-framework doctor
STATUS: CRITICAL
```
...
- `src/add_framework/doctor_checks.py` - 1407 lines (threshold: 800)
...
- `src/add_framework/repair.py` - 1386 lines (threshold: 800)
...
*Generated by `add-framework doctor`*