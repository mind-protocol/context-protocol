...
Use templates from `.add-framework/templates/`.
...
**IMPORTANT:** Suggestions with `[ ]` checkboxes will be detected by `add-framework repair` and offered to the user interactively. If accepted, an agent will be spawned to implement the suggestion.
