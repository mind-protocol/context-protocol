...
|--------|--------------|-------------|
| `engine/physics/tick.py` | `GraphTick.run()` | flips + energy stats |
| `engine/infrastructure/canon/` | `record_to_canon()` | surfaced moments |

---

## MARKERS

<!-- @ngram:todo Define default interval values for each speed. -->
<!-- @ngram:todo Decide pause behavior for pending canon outputs. -->
