...
1. World-Runner correctness — preserve core invariants.
2. World-Runner clarity — keep observable outputs legible.
3. World-Runner performance — stay within intended budgets.
