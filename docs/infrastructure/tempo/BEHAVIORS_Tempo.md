...
<!-- @ngram:todo Decide per-tick cap for canon surfacing. -->
<!-- @ngram:todo Determine how tempo reports backlog to operators. -->
<!-- @ngram:proposition expose cadence metrics for health checks. -->
