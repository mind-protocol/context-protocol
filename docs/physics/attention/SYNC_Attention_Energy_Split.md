...
- **Files:** `engine/physics/attention_split_sink_mass_distribution_mechanism.py`.
...
<!-- @ngram:todo Define player_neighborhood() boundary (links + depth) -->
<!-- @ngram:todo Wire attention split into runtime tick/runner -->
