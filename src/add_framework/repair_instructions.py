"""
Issue instructions for ADD Framework repair agents.
...
def get_issue_instructions(issue: DoctorIssue, target_dir: Path) -> Dict[str, Any]:
    ...
    instructions = {
        "MONOLITH": {
            ...
            "docs_to_read": [
                ".add-framework/views/VIEW_Refactor_Improve_Code_Structure.md",
...
""",
            "docs_to_update": [".add-framework/state/SYNC_Project_State.md"],
        },
        ...
        "UNDOCUMENTED": {
            ...
            "docs_to_read": [
                ".add-framework/views/VIEW_Document_Create_Module_Documentation.md",
                ".add-framework/PROTOCOL.md",
                ".add-framework/templates/PATTERNS_TEMPLATE.md",
                ".add-framework/templates/SYNC_TEMPLATE.md",
                "modules.yaml",
            ],
...
""",
        ...
        "STALE_SYNC": {
            ...
            "docs_to_read": [
                ".add-framework/views/VIEW_Implement_Write_Or_Modify_Code.md",
...
3. For EACH missing doc type:
   ...
   c. If not found: create using templates from `.add-framework/templates/`
...
""",
        ...
        "MISSING_TESTS": {
            ...
            "docs_to_read": [
                ".add-framework/views/VIEW_Test_Write_Tests_And_Verify.md",
                "modules.yaml",
            ],
...
""",
        ...
        "ARBITRAGE": {
            ...
            "docs_to_read": [
                ".add-framework/views/VIEW_Specify_Design_Vision_And_Architecture.md",
                issue.path,
            ],
...
""",
    ...
    return instructions.get(issue.issue_type, {
        ...
        "docs_to_read": [".add-framework/PROTOCOL.md"],
...
Review and fix this issue following the ADD Framework.
