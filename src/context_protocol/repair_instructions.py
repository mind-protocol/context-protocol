"""
Issue instructions for Context Protocol repair agents.
...
3. For EACH missing doc type:
   ...
   c. If not found: create using templates from `.context-protocol/templates/`
...
""",
        ...
        "MISSING_TESTS": {
            ...
            "docs_to_read": [
                ".context-protocol/views/VIEW_Test_Write_Tests_And_Verify.md",
                "modules.yaml",
            ],
...
""",
        ...
        "ARBITRAGE": {
            ...
            "docs_to_read": [
                ".context-protocol/views/VIEW_Specify_Design_Vision_And_Architecture.md",
                issue.path,
            ],
