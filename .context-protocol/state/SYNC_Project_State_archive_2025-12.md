...
Files created:
- `src/context_protocol/doctor_report.py` (465 lines) - Report generation, printing, issue explanations
- `src/context_protocol/doctor_types.py` (41 lines) - DoctorIssue and DoctorConfig dataclasses

Files modified:
- `src/context_protocol/doctor.py` - Removed 5 functions (generate_health_markdown, print_doctor_report, check_sync_status, get_issue_guidance, get_issue_explanation) and dataclasses; added imports from new modules
