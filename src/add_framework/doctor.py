"""
Doctor command for ADD Framework CLI.
...
def doctor_command(
    ...
    if github_issues:
        mapping_path = target_dir / ".add-framework" / "state" / "github_issues.json"
    ...
    if not no_save and output_format != "json":
        health_path = target_dir / ".add-framework" / "state" / "SYNC_Project_Health.md"
