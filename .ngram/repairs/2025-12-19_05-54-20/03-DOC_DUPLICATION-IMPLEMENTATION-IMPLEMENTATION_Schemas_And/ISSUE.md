...
**Severity:** warning
**Target:** docs/protocol/IMPLEMENTATION/IMPLEMENTATION_Schemas_And_Config.md
...
**Details:** {'doc_type': 'IMPLEMENTATION', 'folder': 'IMPLEMENTATION', 'docs': ['docs/protocol/IMPLEMENTATION/IMPLEMENTATION_Schemas_And_Config.md', 'docs/protocol/IMPLEMENTATION/IMPLEMENTATION_File_Structure.md', 'docs/protocol/IMPLEMENTATION/IMPLEMENTATION_Overview.md', 'docs/protocol/IMPLEMENTATION/IMPLEMENTATION_Flows_And_Links.md']}
...
- docs/protocol/IMPLEMENTATION/IMPLEMENTATION_Schemas_And_Config.md
