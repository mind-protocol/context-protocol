...
|------|----------------|---------------|
| `engine/physics/attention_split_sink_mass_distribution_mechanism.py` | Compute sink mass, softmax split, energy blend | `apply_attention_split`, `compute_sink_mass` |
