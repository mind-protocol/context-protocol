...
| Tension Release | The sudden, sharp recoil of an element that was under strain. The motion is fast and energetic but resolves immediately (e.g., an ease-in-out-expo curve). | A link snapping into a new state as a condition is met; a collapsed UI section expanding with force. |
