...
Manager bootstrap uses `.ngram/agents/manager/CLAUDE.md` and writes a sibling
`AGENTS.md` for Codex/Gemini compatibility, mirroring
`templates/ngram/agents/manager/CLAUDE.md` with the same Codex addition.
