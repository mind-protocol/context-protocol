...
**File sizes:** [('IMPLEMENTATION_CLI_Code_Architecture.md', '13K'), ('ALGORITHM_CLI_Logic.md', '7K'), ('SYNC_CLI_State.md', '6K'), ('BEHAVIORS_CLI_Command_Effects.md', '6K'), ('SYNC_CLI_State_archive_2025-12.md', '6K')]
...
## Archiving pattern:
- Create `docs/cli/archive/SYNC_archive_2024-12.md` for old content
